...
import {
  ...
  Bundles,
} from './resources/bundles/bundles';
import {
  Order,
  OrderCancelAwbParams,
  OrderCancelAwbResponse,
  OrderChangeStatusParams,
  OrderChangeStatusResponse,
  OrderCheckPaymentResponse,
  OrderCheckSettlementResponse,
  OrderCreateParams,
  OrderCreatePaymentResponse,
  OrderCreateResponse,
  OrderCreateShipmentStatusHistoryParams,
  OrderCreateShipmentStatusHistoryResponse,
  OrderDeleteParams,
  OrderDeleteResponse,
  OrderDuplicateParams,
  OrderDuplicateResponse,
  OrderGenerateAwbParams,
  OrderGenerateAwbResponse,
  OrderGetActionsResponse,
  OrderGetChatParams,
  OrderGetChatResponse,
  OrderGetChatsResponse,
  ...
  OrderMarkNotSpamResponse,
  OrderRetrieveByPgReferenceIDResponse,
  OrderRetrieveByPgReferenceIDsParams,
  OrderRetrieveByPgReferenceIDsResponse,
  OrderRetrieveResponse,
  OrderSendLmsAccessResponse,
  OrderSendProductDigitalResponse,
  OrderStatisticsParams,
  OrderStatisticsResponse,
  OrderTriggerPurchaseResponse,
  OrderUpdateCustomerParams,
  OrderUpdateCustomerResponse,
  OrderUpdateParams,
  OrderUpdateResponse,
  OrderUpdateShipmentParams,
  OrderUpdateShipmentReceiptParams,
  OrderUpdateShipmentReceiptResponse,
  OrderUpdateShipmentResponse,
  OrderUpdateTagsParams,
  OrderUpdateTagsResponse,
  OrderUploadChangeStatusParams,
  OrderUploadChangeStatusResponse,
  OrderUploadParams,
  OrderUploadReceiptParams,
  OrderUploadReceiptResponse,
  OrderUploadResponse,
} from './resources/order/order';
import {
  ProductCountParams,
...
export interface ClientOptions {
   ...
   *
   * Defaults to process.env['SCALEV_API_BASE_URL'].
   */
   ...
   * Set the log level.
   *
   * Defaults to process.env['SCALEV_API_LOG'] or 'warn' if it isn't set.
   */
...
export class ScalevAPI {
  ...
  constructor({
    ...
    const options: ClientOptions = {
      apiKey,
      ...opts,
      baseURL: baseURL || `https://api.scalev.id`,
    };

    this.baseURL = options.baseURL!;
    this.timeout = options.timeout ?? ScalevAPI.DEFAULT_TIMEOUT /* 1 minute */;
    ...
    this.logLevel =
      ...
      parseLogLevel(readEnv('SCALEV_API_LOG'), "process.env['SCALEV_API_LOG']", this) ??
      defaultLogLevel;
  ...
  #baseURLOverridden(): boolean {
    return this.baseURL !== 'https://api.scalev.id';
  }
  ...
  static ScalevAPI = this;
  static DEFAULT_TIMEOUT = 60000; // 1 minute

  static ScalevAPIError = Errors.ScalevAPIError;
  ...
  productTaxonomies: API.ProductTaxonomies = new API.ProductTaxonomies(this);
  products: API.Products = new API.Products(this);
  shippingCosts: API.ShippingCosts = new API.ShippingCosts(this);
  stores: API.Stores = new API.Stores(this);
  variants: API.Variants = new API.Variants(this);
}

ScalevAPI.Bundles = Bundles;
ScalevAPI.Businesses = Businesses;
ScalevAPI.Locations = Locations;
ScalevAPI.Order = Order;
ScalevAPI.ProductTaxonomies = ProductTaxonomies;
ScalevAPI.Products = Products;
ScalevAPI.ShippingCosts = ShippingCosts;
ScalevAPI.Stores = Stores;
ScalevAPI.Variants = Variants;
...
export declare namespace ScalevAPI {
  ...
  export {
    ...
    type BusinessRetrieveEnabledEpaymentsResponse as BusinessRetrieveEnabledEpaymentsResponse,
  };
  ...
  export { Variants as Variants, type VariantRetrieveResponse as VariantRetrieveResponse };
}
