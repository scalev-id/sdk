...
export class Bundles extends APIResource {
  ...
  update(
    id: number,
    body: BundleUpdateParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<BundleUpdateResponse> {
    return this._client.patch(path`/v2/bundles/${id}`, { body, ...options });
  }
...
export interface BundleUpdateResponse {
  ...
  data?: BundleUpdateResponse.Data;

  status?: string;
}

export namespace BundleUpdateResponse {
  export interface Data {
    /**
     * Bundle ID
     */
...
export interface BundleUpdateParams {
   ...
   * List of Bundle Lines
   */
  bundlelines?: Array<BundleUpdateParams.Bundleline>;
...
export namespace BundleUpdateParams {
  export interface Bundleline {
    /**
     * Quantity of the variant in the bundle line
     */
