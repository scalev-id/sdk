...
export class FollowUpChats extends APIResource {
  ...
  create(
    ...
    return this._client.post(path`/v2/bundles/${bundleID}/follow-up-chats`, { body, ...options });
  }
  ...
  retrieve(
    ...
    return this._client.get(path`/v2/bundles/${bundle_id}/follow-up-chats/${id}`, options);
  }
  ...
  update(
    ...
    return this._client.patch(path`/v2/bundles/${bundle_id}/follow-up-chats/${id}`, { body, ...options });
  }
  ...
  list(
    ...
    return this._client.get(path`/v2/bundles/${bundleID}/follow-up-chats`, { query, ...options });
  }
  ...
  delete(
    ...
    const { bundle_id } = params;
    return this._client.delete(path`/v2/bundles/${bundle_id}/follow-up-chats/${id}`, options);
  }

  /**
   * Generates a new follow up chat for a bundle.
   */
  generate(bundleID: number, options?: RequestOptions): APIPromise<FollowUpChatGenerateResponse> {
    return this._client.post(path`/v2/bundles/${bundleID}/follow-up-chats/generate`, options);
  }
}
