...
export const tool: Tool = {
  ...
  inputSchema: {
    ...
    required: ['bundle_id', 'id', 'name', 'price'],
  },
  annotations: {},
};
...
export const handler = async (client: ScalevAPI, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await maybeFilter(jq_filter, await client.bundles.bpos.update(id, body)));
};
