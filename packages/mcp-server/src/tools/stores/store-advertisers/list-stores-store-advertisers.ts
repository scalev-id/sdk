...
export const handler = async (client: ScalevAPI, args: Record<string, unknown> | undefined) => {
  ...
  const response = await client.stores.storeAdvertisers.list(store_id, body).asResponse();
