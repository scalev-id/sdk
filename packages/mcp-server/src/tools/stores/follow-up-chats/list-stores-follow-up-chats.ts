...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'get',
  httpPath: '/v2/stores/{store_id}/follow-up-chats',
  operationId: 'ScalevApiWeb.FollowUpChatController.index_fucs',
};

export const tool: Tool = {
  name: 'list_stores_follow_up_chats',
  description:
...
export const handler = async (client: ScalevAPI, args: Record<string, unknown> | undefined) => {
  ...
  const response = await client.stores.followUpChats.list(store_id, body).asResponse();
