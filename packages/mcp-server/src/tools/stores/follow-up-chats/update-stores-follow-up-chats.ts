...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'patch',
  httpPath: '/v2/stores/{store_id}/follow-up-chats/{id}',
  operationId: 'ScalevApiWeb.FollowUpChatController.update_fuc',
};

export const tool: Tool = {
  name: 'update_stores_follow_up_chats',
  description:
  ...
  inputSchema: {
    ...
    required: ['store_id', 'id', 'name', 'provider'],
  },
  annotations: {},
};
...
export const handler = async (client: ScalevAPI, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(
    await maybeFilter(jq_filter, await client.stores.followUpChats.update(id, body)),
  );
};
