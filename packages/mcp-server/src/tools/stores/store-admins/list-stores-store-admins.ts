...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'get',
  httpPath: '/v2/stores/{store_id}/store-admins',
  operationId: 'ScalevApiWeb.StoreController.index_store_admin',
};

export const tool: Tool = {
  name: 'list_stores_store_admins',
  description:
    "When using this tool, always use the `jq_filter` parameter to reduce the response size and improve performance.\n\nOnly omit if you're sure you don't need the data.\n\nRetrieves a paginated list of store admins associated with a specific store. The data is sorted by id in descending order and cannot be changed. Uses cursor-based pagination with default page size of 25 and maximum of 25.\n\n# Response Schema\n```json\n{\n  type: 'object',\n  properties: {\n    code: {\n      type: 'integer'\n    },\n    data: {\n      type: 'object',\n      properties: {\n        has_next: {\n          type: 'boolean'\n        },\n        last_id: {\n          type: 'integer'\n        },\n        page_size: {\n          type: 'integer'\n        },\n        results: {\n          type: 'array',\n          items: {\n            $ref: '#/$defs/store_admin_list_response'\n          }\n        }\n      }\n    },\n    status: {\n      type: 'string'\n    }\n  },\n  $defs: {\n    store_admin_list_response: {\n      type: 'object',\n      title: 'BusinessUser',\n      properties: {\n        id: {\n          type: 'integer',\n          description: 'The business user ID'\n        },\n        business_phone: {\n          type: 'string',\n          description: 'The business phone number'\n        },\n        role: {\n          type: 'object',\n          title: 'SimpleRole',\n          properties: {\n            id: {\n              type: 'integer',\n              description: 'The role ID'\n            },\n            name: {\n              type: 'string',\n              description: 'The name of the role'\n            }\n          },\n          required: [            'id',\n            'name'\n          ]\n        },\n        user: {\n          type: 'object',\n          title: 'UserSimple',\n          properties: {\n            id: {\n              type: 'integer',\n              description: 'User ID'\n            },\n            aff_code: {\n              type: 'string',\n              description: 'Affiliate code of the user'\n            },\n            avatar: {\n              type: 'string',\n              description: 'URL to user avatar'\n            },\n            email: {\n              type: 'string',\n              description: 'User email'\n            },\n            fullname: {\n              type: 'string',\n              description: 'User full name'\n            },\n            phone: {\n              type: 'string',\n              description: 'User phone number'\n            }\n          }\n        }\n      },\n      required: [        'id',\n        'business_phone',\n        'role',\n        'user'\n      ]\n    }\n  }\n}\n```",
  inputSchema: {
    type: 'object',
    properties: {
      store_id: {
...
export const handler = async (client: ScalevAPI, args: Record<string, unknown> | undefined) => {
  ...
  const response = await client.stores.storeAdmins.list(store_id, body).asResponse();
