...
export const tool: Tool = {
  name: 'create_products_follow_up_chats',
  description:
  ...
  inputSchema: {
    ...
    required: ['product_id', 'name', 'provider'],
  },
  annotations: {},
};
...
export const handler = async (client: ScalevAPI, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(
    await maybeFilter(jq_filter, await client.products.followUpChats.create(product_id, body)),
  );
};
