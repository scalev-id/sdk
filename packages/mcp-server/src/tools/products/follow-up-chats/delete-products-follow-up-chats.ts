...
export const tool: Tool = {
  name: 'delete_products_follow_up_chats',
  description:
    "When using this tool, always use the `jq_filter` parameter to reduce the response size and improve performance.\n\nOnly omit if you're sure you don't need the data.\n\nDeletes a follow up chat template.\n\n# Response Schema\n```json\n{\n  $ref: '#/$defs/follow_up_chat_delete_response',\n  $defs: {\n    follow_up_chat_delete_response: {\n      type: 'object',\n      title: 'BlankSuccessResponse',\n      properties: {\n        code: {\n          type: 'integer'\n        },\n        status: {\n          type: 'string'\n        }\n      }\n    }\n  }\n}\n```",
  inputSchema: {
    type: 'object',
    properties: {
      product_id: {
...
export const handler = async (client: ScalevAPI, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(
    await maybeFilter(jq_filter, await client.products.followUpChats.delete(id, body)),
  );
};
