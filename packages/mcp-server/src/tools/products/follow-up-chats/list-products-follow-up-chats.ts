...
export const handler = async (client: ScalevAPI, args: Record<string, unknown> | undefined) => {
  ...
  const response = await client.products.followUpChats.list(product_id, body).asResponse();
