...
export const tool: Tool = {
  ...
  inputSchema: {
    ...
    required: ['product_id', 'id', 'name', 'provider'],
  },
  annotations: {},
};
...
export const handler = async (client: ScalevAPI, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(
    await maybeFilter(jq_filter, await client.products.followUpChats.update(id, body)),
  );
};
